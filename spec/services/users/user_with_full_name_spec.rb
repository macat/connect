...
describe Users::UserWithFullName do 
  ...
  describe "#full_name" do
    ...
    it "combines the first and last names" do
      expect(decorator.full_name).to eq "Kate Libby"
    end
    ...
    context "when only first name is set" do
      ...
      it "returns that name" do
        expect(decorator.full_name).to eq "Kate"
      end
    end
    ...
    context "when only last name is set" do 
      ...
      it "returns last name" do 
        expect(decorator.full_name).to eq "Libby"
      end
    end
    ...
    context "when no names are set" do
      ...
      it "returns the empty string" do
        expect(decorator.full_name).to eq ""
      end
    end
  end
end
